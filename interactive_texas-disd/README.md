# interactive_interactive-texas-disd
...
`gulp publish` will upload your [`dist/`](dist/) folder to the `2019/interactive-texas-disd/` folder on our interactives S3 bucket.
