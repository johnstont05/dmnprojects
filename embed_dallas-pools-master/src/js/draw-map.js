...
export default function(map, privatePools, publicPools) {
  ...
  map.addSource('privatePools', {
    type: 'geojson',
    data: privatePools,
  });

  map.addSource('publicPools', {
    type: 'geojson',
    data: publicPools,
  });
  ...
  privatePools.features.forEach(feature => bounds.extend(feature.geometry.coordinates));
  ...
  $('.btn-group li').click(function() {
    ...
    var dataLayers = ['income', 'poverty', 'race'];
