...
`gulp publish` will upload your [`dist/`](dist/) folder to the `embeds/2019/oncor-poweroutages/` folder on our interactives S3 bucket.
...
```html
<div id="embed-oncor-poweroutages"></div>

<script src="//pym.nprapps.org/pym.v1.min.js"></script>
<script>new pym.Parent('embed-oncor-poweroutages', '//interactives.dallasnews.com/embeds/2019/oncor-poweroutages/', {})</script>
```
